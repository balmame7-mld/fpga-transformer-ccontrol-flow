...
#ifndef ATTENTION_BIAS_SW_H
#define ATTENTION_BIAS_SW_H

#define SW_NUM_HEADS 2
#define SW_D_HEAD    8
#define SW_D_MODEL   16
#define SW_D_FF      32

static const float sw_in_proj_bias_q[SW_NUM_HEADS][SW_D_HEAD] = {
...
static const float sw_in_proj_bias_k[SW_NUM_HEADS][SW_D_HEAD] = {
...
static const float sw_in_proj_bias_v[SW_NUM_HEADS][SW_D_HEAD] = {
...
static const float sw_out_proj_bias_q[SW_D_MODEL] = { -0.01111767f, -0.00213841f, -0.04043913f, -0.01444229f, -0.01557749f, 0.00204321f, -0.01735768f, 0.05526396f, 0.05034024f, -0.03302771f, -0.04256776f, 0.07107101f, -0.02045363f, -0.01431303f, 0.05494328f, -0.03755838f };
static const float sw_ffn0_bias_q[SW_D_FF] = { -0.04208947f, 0.13222882f, 0.10590526f, -0.09459440f, 0.22900051f, -0.01329507f, -0.02860511f, 0.17172424f, -0.04338197f, -0.08641671f, -0.07573420f, -0.09928919f, -0.11779384f, 0.06062491f, 0.20024651f, -0.01780170f, 0.02609641f, 0.04796306f, 0.15043186f, -0.12724704f, -0.17082204f, 0.18452628f, 0.22647588f, 0.05083919f, -0.02621777f, 0.16345401f, 0.09322930f, 0.11132289f, 0.21088001f, 0.09774239f, 0.10811301f, -0.01777509f };
static const float sw_ffn2_bias_q[SW_D_MODEL] = { -0.16110682f, -0.10831407f, -0.05125262f, 0.13376917f, -0.15883808f, -0.12453017f, -0.05516414f, 0.11863425f, 0.10534330f, 0.13824409f, 0.13030754f, -0.09164829f, -0.03989961f, -0.14719337f, 0.02319358f, 0.05922856f };
